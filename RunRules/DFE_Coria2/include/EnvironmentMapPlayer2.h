/**\file */
#ifndef SLIC_DECLARATIONS_EnvironmentMapPlayer2_H
#define SLIC_DECLARATIONS_EnvironmentMapPlayer2_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#define EnvironmentMapPlayer2_DisplayTotalWidth (1138)
#define EnvironmentMapPlayer2_DisplayActiveHeight (1920)
#define EnvironmentMapPlayer2_DisplayActiveWidth (1080)
#define EnvironmentMapPlayer2_DisplayTotalHeight (1933)
 ...
 */
void EnvironmentMapPlayer2_memoryInitialisation(
 ...
 */
max_run_t *EnvironmentMapPlayer2_memoryInitialisation_nonblock(
	int32_t param_address,
	int32_t param_size,
	const int32_t *instream_environment_map_in);
...
} EnvironmentMapPlayer2_memoryInitialisation_actions_t;
 ...
 */
void EnvironmentMapPlayer2_memoryInitialisation_run(
	max_engine_t *engine,
	EnvironmentMapPlayer2_memoryInitialisation_actions_t *interface_actions);
 ...
 */
max_run_t *EnvironmentMapPlayer2_memoryInitialisation_run_nonblock(
	max_engine_t *engine,
	EnvironmentMapPlayer2_memoryInitialisation_actions_t *interface_actions);
 ...
 */
void EnvironmentMapPlayer2_memoryInitialisation_run_group(max_group_t *group, EnvironmentMapPlayer2_memoryInitialisation_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer2_memoryInitialisation_run_group_nonblock(max_group_t *group, EnvironmentMapPlayer2_memoryInitialisation_actions_t *interface_actions);
 ...
 */
void EnvironmentMapPlayer2_memoryInitialisation_run_array(max_engarray_t *engarray, EnvironmentMapPlayer2_memoryInitialisation_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer2_memoryInitialisation_run_array_nonblock(max_engarray_t *engarray, EnvironmentMapPlayer2_memoryInitialisation_actions_t *interface_actions[]);
 ...
 */
max_actions_t* EnvironmentMapPlayer2_memoryInitialisation_convert(max_file_t *maxfile, EnvironmentMapPlayer2_memoryInitialisation_actions_t *interface_actions);
 ...
 * \return A handle on the execution status, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer2_nonblock(
	uint64_t inscalar_MapSampleReaderKernel_backgroundColour,
	uint64_t inscalar_MaxVideoSignalKernel_HSyncPolarity,
	uint64_t inscalar_MaxVideoSignalKernel_VSyncPolarity,
	double inscalar_RayCasterKernel_ipd,
...
} EnvironmentMapPlayer2_actions_t;
 ...
 * \param [in,out] interface_actions Actions to be executed.
 */
void EnvironmentMapPlayer2_run(
	max_engine_t *engine,
	EnvironmentMapPlayer2_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer2_run_nonblock(
	max_engine_t *engine,
	EnvironmentMapPlayer2_actions_t *interface_actions);
 ...
 * Run the actions on the first device available in the group.
 */
void EnvironmentMapPlayer2_run_group(max_group_t *group, EnvironmentMapPlayer2_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer2_run_group_nonblock(max_group_t *group, EnvironmentMapPlayer2_actions_t *interface_actions);
 ...
 * must match the size of engarray.
 */
void EnvironmentMapPlayer2_run_array(max_engarray_t *engarray, EnvironmentMapPlayer2_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer2_run_array_nonblock(max_engarray_t *engarray, EnvironmentMapPlayer2_actions_t *interface_actions[]);
 ...
 * \return The dynamic-interface actions to run, or NULL in case of error.
 */
max_actions_t* EnvironmentMapPlayer2_convert(max_file_t *maxfile, EnvironmentMapPlayer2_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* EnvironmentMapPlayer2_init(void);

/* Error handling functions */
int EnvironmentMapPlayer2_has_errors(void);
const char* EnvironmentMapPlayer2_get_errors(void);
void EnvironmentMapPlayer2_clear_errors(void);
/* Free statically allocated maxfile data */
void EnvironmentMapPlayer2_free(void);
/* These are dummy functions for hardware builds. */
int EnvironmentMapPlayer2_simulator_start(void);
int EnvironmentMapPlayer2_simulator_stop(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_EnvironmentMapPlayer2_H */
