/**\file */
#ifndef SLIC_DECLARATIONS_EnvironmentMapPlayer6_H
#define SLIC_DECLARATIONS_EnvironmentMapPlayer6_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#define EnvironmentMapPlayer6_DisplayTotalWidth (1138)
#define EnvironmentMapPlayer6_DisplayActiveHeight (1920)
#define EnvironmentMapPlayer6_DisplayActiveWidth (1080)
#define EnvironmentMapPlayer6_DisplayTotalHeight (1933)
 ...
 */
void EnvironmentMapPlayer6_memoryInitialisation(
 ...
 */
max_run_t *EnvironmentMapPlayer6_memoryInitialisation_nonblock(
	int32_t param_address,
	int32_t param_size,
	const int32_t *instream_environment_map_in);
...
} EnvironmentMapPlayer6_memoryInitialisation_actions_t;
 ...
 */
void EnvironmentMapPlayer6_memoryInitialisation_run(
	max_engine_t *engine,
	EnvironmentMapPlayer6_memoryInitialisation_actions_t *interface_actions);
 ...
 */
max_run_t *EnvironmentMapPlayer6_memoryInitialisation_run_nonblock(
	max_engine_t *engine,
	EnvironmentMapPlayer6_memoryInitialisation_actions_t *interface_actions);
 ...
 */
void EnvironmentMapPlayer6_memoryInitialisation_run_group(max_group_t *group, EnvironmentMapPlayer6_memoryInitialisation_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer6_memoryInitialisation_run_group_nonblock(max_group_t *group, EnvironmentMapPlayer6_memoryInitialisation_actions_t *interface_actions);
 ...
 */
void EnvironmentMapPlayer6_memoryInitialisation_run_array(max_engarray_t *engarray, EnvironmentMapPlayer6_memoryInitialisation_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer6_memoryInitialisation_run_array_nonblock(max_engarray_t *engarray, EnvironmentMapPlayer6_memoryInitialisation_actions_t *interface_actions[]);
 ...
 */
max_actions_t* EnvironmentMapPlayer6_memoryInitialisation_convert(max_file_t *maxfile, EnvironmentMapPlayer6_memoryInitialisation_actions_t *interface_actions);
 ...
 * \return A handle on the execution status, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer6_nonblock(
	uint64_t inscalar_MapSampleReaderKernel_backgroundColour,
	uint64_t inscalar_MaxVideoSignalKernel_HSyncPolarity,
	uint64_t inscalar_MaxVideoSignalKernel_VSyncPolarity,
	double inscalar_RayCasterKernel_ipd,
...
} EnvironmentMapPlayer6_actions_t;
 ...
 * \param [in,out] interface_actions Actions to be executed.
 */
void EnvironmentMapPlayer6_run(
	max_engine_t *engine,
	EnvironmentMapPlayer6_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer6_run_nonblock(
	max_engine_t *engine,
	EnvironmentMapPlayer6_actions_t *interface_actions);
 ...
 * Run the actions on the first device available in the group.
 */
void EnvironmentMapPlayer6_run_group(max_group_t *group, EnvironmentMapPlayer6_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer6_run_group_nonblock(max_group_t *group, EnvironmentMapPlayer6_actions_t *interface_actions);
 ...
 * must match the size of engarray.
 */
void EnvironmentMapPlayer6_run_array(max_engarray_t *engarray, EnvironmentMapPlayer6_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer6_run_array_nonblock(max_engarray_t *engarray, EnvironmentMapPlayer6_actions_t *interface_actions[]);
 ...
 * \return The dynamic-interface actions to run, or NULL in case of error.
 */
max_actions_t* EnvironmentMapPlayer6_convert(max_file_t *maxfile, EnvironmentMapPlayer6_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* EnvironmentMapPlayer6_init(void);

/* Error handling functions */
int EnvironmentMapPlayer6_has_errors(void);
const char* EnvironmentMapPlayer6_get_errors(void);
void EnvironmentMapPlayer6_clear_errors(void);
/* Free statically allocated maxfile data */
void EnvironmentMapPlayer6_free(void);
/* These are dummy functions for hardware builds. */
int EnvironmentMapPlayer6_simulator_start(void);
int EnvironmentMapPlayer6_simulator_stop(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_EnvironmentMapPlayer6_H */
