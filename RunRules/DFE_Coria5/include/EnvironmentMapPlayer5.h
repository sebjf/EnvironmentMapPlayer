/**\file */
#ifndef SLIC_DECLARATIONS_EnvironmentMapPlayer5_H
#define SLIC_DECLARATIONS_EnvironmentMapPlayer5_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#define EnvironmentMapPlayer5_DisplayTotalWidth (1138)
#define EnvironmentMapPlayer5_DisplayActiveHeight (1920)
#define EnvironmentMapPlayer5_DisplayActiveWidth (1080)
#define EnvironmentMapPlayer5_DisplayTotalHeight (1933)
 ...
 */
void EnvironmentMapPlayer5_memoryInitialisation(
 ...
 */
max_run_t *EnvironmentMapPlayer5_memoryInitialisation_nonblock(
	int32_t param_address,
	int32_t param_size,
	const int32_t *instream_environment_map_in);
...
} EnvironmentMapPlayer5_memoryInitialisation_actions_t;
 ...
 */
void EnvironmentMapPlayer5_memoryInitialisation_run(
	max_engine_t *engine,
	EnvironmentMapPlayer5_memoryInitialisation_actions_t *interface_actions);
 ...
 */
max_run_t *EnvironmentMapPlayer5_memoryInitialisation_run_nonblock(
	max_engine_t *engine,
	EnvironmentMapPlayer5_memoryInitialisation_actions_t *interface_actions);
 ...
 */
void EnvironmentMapPlayer5_memoryInitialisation_run_group(max_group_t *group, EnvironmentMapPlayer5_memoryInitialisation_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer5_memoryInitialisation_run_group_nonblock(max_group_t *group, EnvironmentMapPlayer5_memoryInitialisation_actions_t *interface_actions);
 ...
 */
void EnvironmentMapPlayer5_memoryInitialisation_run_array(max_engarray_t *engarray, EnvironmentMapPlayer5_memoryInitialisation_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer5_memoryInitialisation_run_array_nonblock(max_engarray_t *engarray, EnvironmentMapPlayer5_memoryInitialisation_actions_t *interface_actions[]);
 ...
 */
max_actions_t* EnvironmentMapPlayer5_memoryInitialisation_convert(max_file_t *maxfile, EnvironmentMapPlayer5_memoryInitialisation_actions_t *interface_actions);
 ...
 * \return A handle on the execution status, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer5_nonblock(
	uint64_t inscalar_MapSampleReaderKernel_backgroundColour,
	uint64_t inscalar_MaxVideoSignalKernel_HSyncPolarity,
	uint64_t inscalar_MaxVideoSignalKernel_VSyncPolarity,
	double inscalar_RayCasterKernel_ipd,
...
} EnvironmentMapPlayer5_actions_t;
 ...
 * \param [in,out] interface_actions Actions to be executed.
 */
void EnvironmentMapPlayer5_run(
	max_engine_t *engine,
	EnvironmentMapPlayer5_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer5_run_nonblock(
	max_engine_t *engine,
	EnvironmentMapPlayer5_actions_t *interface_actions);
 ...
 * Run the actions on the first device available in the group.
 */
void EnvironmentMapPlayer5_run_group(max_group_t *group, EnvironmentMapPlayer5_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer5_run_group_nonblock(max_group_t *group, EnvironmentMapPlayer5_actions_t *interface_actions);
 ...
 * must match the size of engarray.
 */
void EnvironmentMapPlayer5_run_array(max_engarray_t *engarray, EnvironmentMapPlayer5_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *EnvironmentMapPlayer5_run_array_nonblock(max_engarray_t *engarray, EnvironmentMapPlayer5_actions_t *interface_actions[]);
 ...
 * \return The dynamic-interface actions to run, or NULL in case of error.
 */
max_actions_t* EnvironmentMapPlayer5_convert(max_file_t *maxfile, EnvironmentMapPlayer5_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* EnvironmentMapPlayer5_init(void);

/* Error handling functions */
int EnvironmentMapPlayer5_has_errors(void);
const char* EnvironmentMapPlayer5_get_errors(void);
void EnvironmentMapPlayer5_clear_errors(void);
/* Free statically allocated maxfile data */
void EnvironmentMapPlayer5_free(void);
/* These are dummy functions for hardware builds. */
int EnvironmentMapPlayer5_simulator_start(void);
int EnvironmentMapPlayer5_simulator_stop(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_EnvironmentMapPlayer5_H */
